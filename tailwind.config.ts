    ...
    extend: {
      ...
      colors: {
        ...
        editor: {
          ...
          'accent-muted': 'hsl(var(--editor-accent-muted))',
      ...
      keyframes: {
        ...
        'pulse-glow': {
          '0%, 100%': {
            boxShadow: '0 0 5px hsl(var(--editor-accent))'
          },
          '50%': {
            boxShadow: '0 0 20px hsl(var(--editor-accent)), 0 0 30px hsl(var(--editor-accent))'
          }
        }
      },
      animation: {
